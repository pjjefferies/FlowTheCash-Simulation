...
class TestLoans(unittest.TestCase):
    ...
    def test_loan_and_payment(self):
        ...
        for a_test in self.tests:
            my_loan = CashFlowSim.src.loans.Loan(
                name=a_test['name'],
...
"""
    ...
    new_balance, new_payment = MY_SECOND_LOAN.make_payment(50000)
    print("New Balance:", new_balance, ", New Payment:", new_payment)
